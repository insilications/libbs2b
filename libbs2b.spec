...
Version  : 3.1.0
Release  : 217
URL      : file:///aot/build/clearlinux/packages/libbs2b/libbs2b-v3.1.0.tar.gz
Source0  : file:///aot/build/clearlinux/packages/libbs2b/libbs2b-v3.1.0.tar.gz
Summary  : Bauer stereophonic-to-binaural DSP library
Group    : Development/Tools
License  : GPL-2.0
Requires: libbs2b-bin = %{version}-%{release}
Requires: libbs2b-lib = %{version}-%{release}
...
%package bin
Summary: bin components for the libbs2b package.
Group: Binaries

%description bin
bin components for the libbs2b package.


%package dev
Summary: dev components for the libbs2b package.
Group: Development
Requires: libbs2b-lib = %{version}-%{release}
Requires: libbs2b-bin = %{version}-%{release}
Provides: libbs2b-devel = %{version}-%{release}
Requires: libbs2b = %{version}-%{release}

%description dev
dev components for the libbs2b package.


%package lib
Summary: lib components for the libbs2b package.
Group: Libraries

%description lib
lib components for the libbs2b package.


%package staticdev
Summary: staticdev components for the libbs2b package.
Group: Default
Requires: libbs2b-dev = %{version}-%{release}

%description staticdev
staticdev components for the libbs2b package.


%prep
%setup -q -n libbs2b-clr
cd %{_builddir}/libbs2b-clr
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1640179675
